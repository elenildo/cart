...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('site_images/favicon.ico') }}">
    <!-- CSRF Token -->
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    <img src="{{ asset('site_images/lojavirtual.png') }}" alt="{{ config('app.name', 'Loja virtual') }}" class="w-50">
                </a>
